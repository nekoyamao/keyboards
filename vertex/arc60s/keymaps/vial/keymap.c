...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_00] = LAYOUT_ansi(
        ...
        LGUI_T(KC_TAB),KC_A, KC_S, KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,   RGUI_T(KC_ENT),
    ...
    [_01] = LAYOUT_ansi(
        ...
        KC_LGUI, KC_NO  ,LSFT(KC_EQL),KC_MINS,KC_EQL,KC_LPRN, KC_RPRN,KC_LEFT , KC_UP  , KC_DOWN, KC_RGHT, KC_NO  ,          KC_ENT ,
    ...
    [_04] = LAYOUT_ansi(
        ...
        KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , RGB_VAD,RGB_M_SW,RGB_M_SN, RGB_M_K, RGB_HUD,RGB_RMOD,          KC_NO  ,
    ...
    [_05] = LAYOUT_ansi(
        ...
        KC_NO  ,LCTL(KC_A),LCTL(KC_S),KC_NO,LCTL(KC_F),KC_NO, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,          KC_NO  ,
